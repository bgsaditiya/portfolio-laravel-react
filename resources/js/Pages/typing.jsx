...
const Typing = () => {
    ...
    return (
        <>
            ...
            <footer className="absolute bottom-0 left-0 w-full text-white text-center p-4 pb-8">
                <div className="w-full pt-10">
                    <div className="flex items-center justify-center mb-2">
                        <a
                            href="https://linkedin.com/in/bagas-aditiya-92a2a3262"
                            target="_blank"
                            className="fill-slate-300 hover:fill-slate-950 hover:bg-slate-300 justify-center transition duration-150 ease-out hover:ease-in mr-3 rounded px-2 py-2"
                        >
                            <svg
                                role="img"
                                width="24"
                    ...
                    <p className="font-medium text-[0.75rem] text-slate-500 text-center">
                        Dibuat dengan <span className="text-red-500">❤️</span>{" "}
                        oleh{" "}
                        <a
                            href="https://www.instagram.com/bgsaditiya_/"
                            target="_blank"
                            className="text-slate-400 hover:text-[#ffda5e]"
                        >
                            Bagas Aditia
                        </a>
                        , menggunakan{" "}
                        <a
                            ...
                            target="_blank"
                            className="text-slate-400 hover:text-tailwind"
                        >
                            Tailwind{" "}
                        </a>
                        ,
                        ...
                        <a
                            href="https://laravel.com/"
                            target="_blank"
                            className="text-slate-400 hover:text-laravel"
                        >
                            Laravel
                        </a>
                    </p>
